...
import type { ApprovalDataRow } from "@/types/approval-data";
import { MoreHorizontal } from "lucide-react";
import { cn } from "@/lib/utils";

interface ApprovalDataTableProps {
  rows: ApprovalDataRow[];
  onRowClick?: (row: ApprovalDataRow) => void;
}
...
/** 승인 데이터 테이블 - Validation Data Table 스타일 */
                ...
                <td className="px-4 py-3" onClick={(e) => e.stopPropagation()}>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem>확정</DropdownMenuItem>
                      <DropdownMenuItem>재오픈</DropdownMenuItem>
                      <DropdownMenuItem>코멘트 보기</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </td>
              </tr>
